...
<form method="post" action="/addAllProductsFromExcel" enctype="multipart/form-data">
    <!-- ... (existing form elements) ... -->
    <div class="form-outline mb-4">
        <label class="form-label" for="excelFile">Upload Excel Sheet</label>
        <input type="file" id="excelFile" class="form-control" name="excelFile" accept=".xlsx, .xls" />
    </div>
    <!-- Add All button -->
    <button type="submit" class="btn btn-primary btn-block">Add All Products from Excel</button>
</form>
