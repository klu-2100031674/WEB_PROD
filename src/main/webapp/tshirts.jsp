            ...
            <div class="product" style="display: inline-block; margin: 10px;">
                <div class="top d-flex">
                    ...
                    <% if (product.getImage() != null){ %>
                        <img src="data:image/jpeg;base64, <%= new String(org.apache.commons.codec.binary.Base64.encodeBase64(product.getImage())) %>" alt="<%= product.getName() %> Image" />
                    <% } else { %>
                        <img src=<%= product.getImage_url() %> alt="" Image" />
                    <% } %>
